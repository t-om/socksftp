...
function getConnectionOptions(proxyOptions) {
  var urlObj = new URL(proxyOptions.socksproxy);
  ...
  return {
    ...
    target: {
      host: proxyOptions.host, // When using bind, it's best to give an estimation of the ip that will be connecting to the newly opened tcp port on the proxy server.
